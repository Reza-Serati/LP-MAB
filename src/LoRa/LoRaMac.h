...
//extern int max_intervalll ;
//extern int sending_interval_timeee;
...
class LoRaMac : public MacProtocolBase
{
  protected:
    ///////////////////////serati////////////////////////////////////
    std::vector<macKnownNode> macKnownNodes;
    /////////////////////////////////////////////////////////////////
    /**
    ...
    /////////////////////////////////Searti/////////////////////////////////////////////
    cMessage *replicatePacket;
    std::string adrMethod;


    int max_interval = 1;
    int sending_interval_time = 1;
    int interval_count = 0;
    bool retransmiting = false;

    Customize_Table c_table_srt;
    /////////////////////////////////////////////////////////////////////////////////
